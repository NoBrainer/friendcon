...
// Get the user data
$userResult = $MySQLi_CON->query(
	"SELECT u.email, u.name, u.uid, u.upoints, h.housename
	 FROM users u
	 JOIN house h ON u.houseid = h.houseid
	 WHERE uid={$userSession}"
);
if(!$userResult) die("User query failed");
...
$userListResult = $MySQLi_CON->query(
	"SELECT u.name, u.uid
	 FROM users u"
);
if(!$userListResult) die("User list query failed");
$userList = array();
...
<div class="container content">
	...
	<div class="container content-card">
		...
		<table class="table">
			<tr>
				...
				<td>
					<div>
						<button class="btn btn-default point-btn enforce-max" value="1" target="#send-points-amount">+1</button>
						<button class="btn btn-default point-btn enforce-max" value="5" target="#send-points-amount">+5</button>
						<button class="btn btn-default point-btn enforce-max" value="10" target="#send-points-amount">+10</button>
						<button class="btn btn-default point-btn enforce-max" value="25" target="#send-points-amount">+25</button>
						<button class="btn btn-default point-btn enforce-max" value="50" target="#send-points-amount">+50</button>
					</div>
					<div>
						<button class="btn btn-default point-btn enforce-max" value="-1" target="#send-points-amount">-1</button>
						<button class="btn btn-default point-btn enforce-max" value="-5" target="#send-points-amount">-5</button>
			...
			<tr>
				<td></td>
				<td><button id="send-points-btn" name="btn-send-points">Send</button></td>
			</tr>
		</table>
	...
	<div class="container content-card">
		...
		<table class="table">
			<tr>
				...
				<td>
					<div>
						...
						<button class="btn btn-default point-btn" value="10" target="#request-points-amount">+10</button>
						<button class="btn btn-default point-btn" value="25" target="#request-points-amount">+25</button>
						<button class="btn btn-default point-btn" value="50" target="#request-points-amount">+50</button>
					</div>
					<div>
						<button class="btn btn-default point-btn" value="-1" target="#request-points-amount">-1</button>
						<button class="btn btn-default point-btn" value="-5" target="#request-points-amount">-5</button>
			...
			<tr>
				<td></td>
				<td><button id="request-points-btn">Request</button></td>
			</tr>
		</table>
	...
	<div class="container content-card">
		...
		<table class="table" style="display:none;">
			<tr>
				...
				<td>
					<div>
						<button class="btn btn-default point-btn point-btn-admin" value="1" target="#admin-points-amount">+1</button>
						<button class="btn btn-default point-btn point-btn-admin" value="5" target="#admin-points-amount">+5</button>
						<button class="btn btn-default point-btn point-btn-admin" value="10" target="#admin-points-amount">+10</button>
						<button class="btn btn-default point-btn point-btn-admin" value="25" target="#admin-points-amount">+25</button>
						<button class="btn btn-default point-btn point-btn-admin" value="50" target="#admin-points-amount">+50</button>
					</div>
					<div>
						<button class="btn btn-default point-btn point-btn-admin" value="-1" target="#admin-points-amount">-1</button>
						<button class="btn btn-default point-btn point-btn-admin" value="-5" target="#admin-points-amount">-5</button>
			...
			<tr>
				<td></td>
				<td><button id="admin-points-btn">Change</button></td>
			</tr>
		</table>
