...
<div class="container content">
	...
	<div class="container content-card">
		<form method="post" id="update-form">
			...
			<div>
				By checking the box, you agree to the <b><a href="http://friendcon.com/code_of_conduct.php" target="_blank">FriendCon Code of Conduct</a></b>.
			</div>
			...
			<div class="last-acknowledged">[Last acknowledged: <span class="timestamp"><?php echo $agreeToTerms; ?></span>]</div>
			...
			<div class="hide-until-acknowledged" style="display:none">
				...
				<div>
					...
					<ol>
						<li>Go to the hotel website: <a href="https://statecollege.place.hyatt.com" target="_new">Hyatt Place State College</a></li>
				...
				<div class="payment-section" style="display:none">
					...
					*/
					...
					<div class="note"><b>How do I pay?</b> Payments must be made when you check-in at FriendCon this year.</div>
					<?php
					/*
