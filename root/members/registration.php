...
include('api-v2/internal/initPaypal.php');
...
<script src="https://www.paypal.com/sdk/js?client-id=<?php echo PAYPAL['CLIENT_ID']; ?>&disable-funding=credit,card"></script>
<script type="text/javascript">
	...
	function saveAcknowledgement() {
		...
		$.ajax({
			...
			statusCode: {
				...
				304: function(jqXHR) {
					alertFailedAcknowledgement("No changes");
				},
				400: function(jqXHR) {
					var resp = jqXHR.responseJSON;
					alertFailedAcknowledgement(resp.error);
				},
				403: function(jqXHR) {
					var resp = jqXHR.responseJSON;
					alertFailedAcknowledgement(resp.error);
	...
	function alertFailedAcknowledgement(message) {
		console.log(message);
