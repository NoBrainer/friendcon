...
$query = $MySQLi_CON->query(
	"SELECT u.email, u.emergencyCn, u.emergencyCNP, u.favoriteAnimal, u.favoriteBooze, u.favoriteNerdism, u.name, u.phone, u.uid, u.isRegistered, u.isPaid, u.isPresent, u.upoints, h.housename AS housename 
	FROM users u 
